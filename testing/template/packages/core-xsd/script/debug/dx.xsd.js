        ...
        (function (Features) {
            ...
            var HighlightTextDocumentFeature = /** @class */ (function (_super) {
                ...
                HighlightTextDocumentFeature.prototype.highlightTextInElement = function (element, text) {
                    ...
                    var textdiacritics = this._diacriticsHelper.removeDiacritics(text);
                    var textRegExp = new RegExp("(^|[\\b\\s]|[^\\w])(".concat(this.escapeForRegExp(textdiacritics), ")(?=$|[\\b\\s]|[^\\w])"), "i");
    ...
    (function (Content) {
        ...
        (function (Features) {
            var DxBaseDocumentFeature = /** @class */ (function (_super) {
                ...
                function DxBaseDocumentFeature() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var DxXsdDocumentFeature = /** @class */ (function (_super) {
                __extends(DxXsdDocumentFeature, _super);
                function DxXsdDocumentFeature() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                DxXsdDocumentFeature.prototype.getName = function () {
                    return "dx-xsd";
                };
                DxXsdDocumentFeature.prototype.populateResponsiveConfiguration = function (configuration) {
                    ...
                    if (configuration.profileName === "mobile" || configuration.profileName === "tablet") {
                        switch (configuration.profileName) {
                            case "tablet":
                                break;
                            case "mobile":
                                configuration.clickTargets.push(new Content.ResponsiveClickTarget("#i-type-section-content a", Content.ResponsiveClickTargetKind.block));
                                var tableSelector = "#i-attributes-section-content table.i-filtered-item-list";
                                var attributesTable = $(tableSelector);
                                if (attributesTable.length) {
                                    var MIN_COLUMNS = 2;
                                    if (attributesTable.find("tr:first-child").children().length > MIN_COLUMNS) {
                                        configuration.tablesToPivot.push(new Content.ResponsiveTable(tableSelector, function (originalTable, pivotDiv) {
                                            pivotDiv.appendTo("#i-attributes-section-content");
                                            originalTable.css("display", "none");
                                        }));
                                    }
                                }
                                break;
                        ...
                        configuration.clickTargets.push(new Content.ResponsiveClickTarget("#i-source.section-content a, .i-item-summary a", Content.ResponsiveClickTargetKind.inline));
                        configuration.clickTargets.push(new Content.ResponsiveClickTarget("#i-usedby.section-content a", Content.ResponsiveClickTargetKind.block));
                    }
                };
                DxXsdDocumentFeature.prototype.applyResponsiveConfiguration = function (configuration) {
                    if (configuration.profileName === "mobile" || configuration.profileName === "tablet") {
                        switch (configuration.profileName) {
                            case "tablet":
                                break;
                            case "mobile":
                                // Relocate namespace section
                                $("#i-namespace").insertBefore("#i-description-section-heading");
                                break;
                            // No default
                        }
                    }
                };
                return DxXsdDocumentFeature;
            }(Features.DxBaseDocumentFeature));
            Features.DxXsdDocumentFeature = DxXsdDocumentFeature;
            var DxXsdDocumentFeatureFactory = /** @class */ (function () {
                function DxXsdDocumentFeatureFactory() {
                }
                DxXsdDocumentFeatureFactory.prototype.createInstance = function (documentInstance) {
                    // Always enabled
                    return new DxXsdDocumentFeature(documentInstance);
                };
                return DxXsdDocumentFeatureFactory;
            }());
            Features.DxXsdDocumentFeatureFactory = DxXsdDocumentFeatureFactory;
        })(Features = Content.Features || (Content.Features = {}));
    })(Content = Innovasys.Content || (Innovasys.Content = {}));
})(Innovasys || (Innovasys = {}));
Innovasys.Content.DocumentFeatureConfiguration.registerDocumentFeatureFactory(new Innovasys.Content.Features.DxXsdDocumentFeatureFactory());

//# sourceMappingURL=innovasys.dx.xsd.js.map
